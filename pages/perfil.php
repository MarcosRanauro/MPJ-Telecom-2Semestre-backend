...
<body>
  ...
  <div class="container-perfil">
    ...
    <a id="edit" name="edit" class='btn btn-sm btn-primary' href='editCadastroComum.php?id=<?php echo $user_data_comum['id']; ?>' title='Editar'> <span aria-hidden="true"> <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
